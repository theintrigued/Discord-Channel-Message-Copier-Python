...
For now, each copy_message function copies a single channel recent texts and pastes them in the channel if your choice.
To add more channels in the copy stream, simply copy the copy_message fuctions and paste them somewhere in the file in the same naming order and change the name of the function.
...
function( 'Channel ID of channel to be copied from', 'Channel ID of channel to be pasted to')
